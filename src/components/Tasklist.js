...
class Tasklist extends React.Component {
    ...
    getProductsAfterSort() {
        ...
        switch (this.state.sort) {
            ...
            case 'sizedown':
                return this.props.products.sort((a,b) => b.size - a.size);
            case 'priceup':
                return this.props.products.sort((a,b) => a.price - b.price);
            case 'pricedown':
                return this.props.products.sort((a,b) => b.price - a.price);
            case 'dateup':
                return this.props.products.sort((a,b) => new Date(b.date).getTime() - new Date(a.date).getTime());
            case 'datedown':
                return this.props.products.sort((a,b) => new Date(a.date).getTime() - new Date(b.date).getTime());  
            default:
                return this.props.products 
        }
    }
